...
| --- | --- | --- | --- | --- | --- |
| YYYY-MM-DD | Example: repository hygiene review | Example: docs and integration doctrine | Example: security guidance reviewed and findings remediated | Example: none identified | Example: owner / closed |
